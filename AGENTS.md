# Agent guide - roff-kotlin

This file is the quick-reference operating contract for roff-kotlin. The longer
...
roff-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`roff`](./README.md). Upstream Rust is the behavioral oracle while the
