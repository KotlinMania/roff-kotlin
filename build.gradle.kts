...
kotlin {
    ...
    macosArm64 {
        binaries.framework { baseName = "Roff"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Roff"; xcf.add(this) }
    }
...
mavenPublishing {
    ...
    pom {
        ...
        description.set("Kotlin Multiplatform port of rust-cli/roff-rs - ROFF (man page format) generation library")
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRoffXCFramework",
    "assembleRoffDebugXCFramework",
    "assembleRoffReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRoffXCFramework",
    "assembleReleaseIosFatFrameworkForRoffXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRoffXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRoffXCFramework",
    "assembleDebugMacosFatFrameworkForRoffXCFramework",
    "assembleReleaseMacosFatFrameworkForRoffXCFramework",
    "assembleDebugTvosFatFrameworkForRoffXCFramework",
    "assembleReleaseTvosFatFrameworkForRoffXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRoffXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRoffXCFramework",
    "assembleDebugWatchosFatFrameworkForRoffXCFramework",
    "assembleReleaseWatchosFatFrameworkForRoffXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRoffXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRoffXCFramework",
