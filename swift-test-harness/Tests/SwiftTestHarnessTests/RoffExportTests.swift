...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Roff.swiftmodule/`
...
//      `import Roff` above would fail at compile time.
//
//   2. The static archive `libRoff.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Roff" }` and
//      `flattenPackage = "io.github.kotlinmania.roff"` configuration in
...
final class RoffExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Roff swift module imported cleanly")
    }
}
